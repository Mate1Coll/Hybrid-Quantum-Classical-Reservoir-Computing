"""Evaluate ESN performance as a function of hyperparameters.

This script computes and optionally plots echo state network performance
across internal parameter sweeps for reservoir computing experiments.
"""
...
if __name__ == "__main__":
    ...
    n_val = 9 # Number of sweeping values for parameter
